$(document).ready(function () {
  movieList();
  // obtener constante desde el almacenamiento local
  ...
  async function editarPelicula(idPelicula) {
    ...
    const usuarioId = miVariable;
    const titulo = document.getElementById('titulo').value;
    const año = document.getElementById('año').value;
    const director = document.getElementById('director').value;
    let imagen;
    const imagen1 = document.getElementById('imagen').files[0];
  ...
  async function getData() {
    try {
      ...
      const data = await response.json();
      console.log(data)
      // Filtrar los datos por el usuarioId deseado
...
<div class="album ">
  ...
  <input type="hidden" class="form-control" id="usuarioId" placeholder="Usuario" required />
...
<div class="col-6 m-3">
  ...
  <div class="col-6 m-3">
  <input type="hidden" class="form-control" id="imagen2" placeholder="Imagen"   />
  </div>
  <div class="col-6 m-3">
  <div class="d-flex gap-4 d-md-flex justify-content-md-end m-3">
  <button class="btn btn-success edit" type="submit" id="editar">Editar</button>
...
<div class="col-6 m-3">
    ...
    <div class="col-6 m-3">
    <div class="d-flex gap-4 d-md-flex justify-content-md-end m-3">
    <button class="btn btn-success " type="submit" id="registrar">Registrar</button>
    <button class="btn btn-primary" type="button" id="atras">Atras</button>
  </div>
  </div>
</div>
