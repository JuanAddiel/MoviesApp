    ...
    await $.each(data, function(index, element) {
      ...
      <div class="card bg-success text-light">
        ...
        <form class="form-inline">
          <a href="#" class="editar btn btn-primary p-3 m-2 ${element.id}">Editar</a>
          <button type="submit" class="btn btn-outline-warning p-3 m-3 delete-libro">Eliminar</button>
        </form>
...
async function createData() {
    ...
    const director = document.getElementById('director').value;
    const imagen = document.getElementById('imagen').value;
    const data = { generoId, usuarioId, titulo, año, director, imagen};
